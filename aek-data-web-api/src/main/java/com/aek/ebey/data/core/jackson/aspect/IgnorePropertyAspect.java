package com.aek.ebey.data.core.jackson.aspect;
...
import com.aek.ebey.data.core.jackson.annotation.IgnoreProperties;
import com.aek.ebey.data.core.jackson.impl.FilterPropertyHandler;
import com.aek.ebey.data.core.jackson.impl.JavassistFilterPropertyHandler;
...
public class IgnorePropertyAspect { 
	...
	@Pointcut("@annotation(com.aek.ebey.data.core.jackson.annotation.IgnoreProperties)")
